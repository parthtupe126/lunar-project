          ...
          <div className="max-w-xl w-full bg-[#0B1120] border border-rose-500/50 rounded-2xl p-6 shadow-2xl space-y-4">
            ...
            <div className="flex items-center gap-3 pt-2">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-cyan-600 to-purple-600 hover:from-cyan-500 hover:to-purple-500 text-white rounded-xl text-xs font-bold transition-[background-color,box-shadow,transform] shadow-glow-cyan cursor-pointer"
              >
