import { LunarSite, LunarMission } from '../types/lunar';
...
export function latLonToVector3(lat: number, lon: number, radius = 1.5) {
...
const RAW_LUNAR_SITES: LunarSite[] = [
  {
    "id": "site-shackleton",
    "code": "Shackleton",
...
const aiPredictionsMap: Record<string, any> = {};
if (aiPredictionsData?.predictions) {
  aiPredictionsData.predictions.forEach((p: any) => {
    aiPredictionsMap[p.id] = p;
  });
}

export const INITIAL_LUNAR_SITES: LunarSite[] = RAW_LUNAR_SITES.map(site => {
