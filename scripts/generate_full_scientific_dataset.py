...
OUTPUT_FILE = "src/data/lunar_scientific_dataset.json"

# Master 23-Node Complete Scientific Ground-Truth Dataset
# Covering all 8 checklist pillars
DATASET = [
    {
        "id": "site-shackleton",
    ...
    },
    {
        ...
        "water_ice": {
            ...
            "radar_cpr": 0.74,
            "spectroscopy_band_3um_depth": 0.080,
    ...
    },
    {
        ...
        "water_ice": {
            ...
            "radar_cpr": 0.95,
            "spectroscopy_band_3um_depth": 0.140,
...
def main():
    ...
    print(f"Generated 100% complete scientific dataset for all {len(DATASET)} nodes at {OUTPUT_FILE}")
